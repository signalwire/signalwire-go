...
// genHeaderTmpl intentionally still names cmd/generate-payloads — the byte output
// of the SWAIG/SWML *_generated.go files must remain identical to what the
// previously-consolidated generate-payloads command emitted (this split is a pure
// refactor; GEN-FRESH byte-compares against the committed files).
