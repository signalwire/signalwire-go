...
//
// sdk-enum: surfaced public enum type. module=signalwire.rest.namespaces.relay_rest_types_generated
// This hand-written enum is the Go realization of the relay-rest spec's
// PhoneCallHandler enum markup — the reference surfaces it as
